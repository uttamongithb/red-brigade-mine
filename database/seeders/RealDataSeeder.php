    ...
    public function run()
    {
        ...
        $team = [
            [
                ...
                'image' => 'sunshine-testimonial-176.JPG',
                'description' => 'Founder and Chief Managing Trustee',
                'type' => 'Executive',
                'status' => 1,
            ...
            [
                ...
                'image' => 'sunshine-testimonial-834.JPG',
                'description' => 'Co-Founder and Secretary',
                'type' => 'Executive',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                'name' => 'Annu Yadav',
                'image' => 'sunshine-testimonial-673.jpeg',
                'description' => 'Treasurer & Coordinator, Bal Manch',
                'type' => 'Executive',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'image' => 'sunshine-testimonial-395.jpg',
            ...
            [
                'name' => 'Suniti Sachan',
                'image' => 'sunshine-testimonial-889.jfif',
                'description' => 'Trustee and Legal Advisor',
                'type' => 'Executive',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ...
            [
                'name' => 'Roshni',
                'image' => 'roshani.jpeg',
                'description' => '<h3>From Fear to Confidence: An Inspiring Journey of an Adolescent Girl</h3><p><strong>Name:</strong> Roshni<br><strong>Age:</strong> 21 years<br><strong>Residence:</strong> Gosainganj, Lucknow, Uttar Pradesh</p><p>Roshni is a young woman from a modest family. Due to her family\'s weak financial condition, she had to balance her education with household responsibilities. She was naturally shy and had limited awareness of her rights and personal safety. She is currently pursuing a <strong>Bachelor of Science (B.Sc.), Third Year</strong>.</p><hr><h3>Challenge</h3><p>Roshni constantly felt unsafe while commuting to and from her college. She was afraid to speak out against harassment or any form of inappropriate behavior. Due to a lack of self-confidence, she also hesitated to express herself in public. Her family was equally concerned about her safety and well-being.</p><hr><h3>Intervention</h3><p>Roshni participated in the <strong>Self-Defense and Women\'s Empowerment Training Program</strong> organized by <strong>Red Brigade</strong>.</p><p>During the training, she received knowledge and practical instruction on:</p><ul><li>Practical self-defense skills</li><li>Gender equality and women\'s rights</li><li>Good Touch–Bad Touch and personal safety</li><li>Legal rights and awareness of helpline services</li><li>Self-confidence, leadership development, and effective communication skills</li></ul><p>Through regular practice sessions, interactive activities, and continuous motivation, the trainers played a significant role in building Roshni\'s confidence and empowering her to face challenges with courage.</p><hr><h3>Impact</h3><p>After successfully completing the training, remarkable positive changes were observed in Roshni.</p><ul><li>She now travels to and from college with confidence and without fear.</li><li>She is capable of standing up against any form of inappropriate behavior or harassment.</li><li>She motivates other adolescent girls to learn self-defense and become aware of their rights.</li><li>She actively participates in awareness campaigns and community activities organized in her college and locality.</li><li>She has developed strong leadership qualities, greater self-confidence, and a sense of self-reliance.</li></ul><p>Today, Roshni has become a positive role model for her family and her community.</p><hr><h3>Testimonial</h3><blockquote><p><em>"Earlier, I was constantly afraid and even hesitated to express my thoughts. The self-defense training not only taught me how to protect myself but also gave me the confidence to live my life with courage and dignity. Today, I am ready to face any challenge, and I also encourage other girls to become aware of their rights and learn self-defense."</em></p></blockquote><hr><h3>Conclusion</h3><p>Roshni\'s journey demonstrates that with proper guidance, self-defense training, and continuous support, a young girl\'s life can be transformed in a positive and meaningful way.</p><p>This program goes beyond teaching physical self-defense skills. It nurtures self-confidence, leadership, awareness, and self-reliance, empowering adolescent girls to become confident individuals and responsible citizens who can contribute positively to society.</p><h4><strong>"An empowered girl is the foundation of a safe, strong, and empowered society."</strong></h4>',
                'type' => 'Leader',
                'status' => 1,
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
        ...
        $initiatives = [
            ...
            [
                ...
                'gallery_images' => json_encode(['vote_campaign_1.jpeg', 'vote_campaign_2.jpeg', 'vote_campaign_3.jpeg', 'vote_campaign_4.jpeg', 'vote_campaign_5.jpeg', 'vote_campaign_6.jpeg', 'vote_campaign_7.jpeg', 'vote_campaign_8.jpeg', 'vote_campaign_9.jpeg', 'vote_campaign_10.jpeg']),
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
