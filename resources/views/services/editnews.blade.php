              ...
              <div class="box-body">
                    ...
                    <div class="col-md-12 create">
						...
						<div class="col-md-8 form-group">
							...
							<input required type="text" id="time_interval" name="time_interval" value="<?php echo $thisdata->time_interval; ?>" class="form-control"  />
						</div>
						<div class="col-md-8 form-group">
							<label for="SAMStudId">City</label>
							<input required type="text" id="city" name="city"  value="<?php echo $thisdata->city; ?>"class="form-control"  />
						</div>
						<div class="col-md-8 form-group">
