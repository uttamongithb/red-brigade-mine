    ...
    <section class="content">
        ...
        <div class="table-container">
            <table class="premium-table">
                ...
                <tbody>
                    <?php
                        if(isset($allskills) && !empty($allskills)){
                            $i = 0;
                            foreach($allskills as $tt){ 
                                $i++;
                                $idget = $tt->id;
                    ?>
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" style="text-align: center; padding: 48px; color: #98a2b3;">
                            <i class="fa fa-cut" style="font-size: 32px; margin-bottom: 12px; display: block;"></i>
                            No skill pillars found.
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
