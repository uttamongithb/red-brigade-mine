...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View All Slider</li>
      </ol>
    </section>
				...
				<div class="box-tools pull-left col-md-12 col-sm-12" style="padding:0px;">
					...
					<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
						<div class="col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
							...
							<a class="btn btn-app pull-left yellowback" href="<?php echo action('ServiceController@viewslider')?>" style="background:rgb(255,152,0);">
								<i class="fa fa-barcode"></i> Slider List
							</a>
							<a class="btn btn-app pull-left greenback" href="<?php echo action('ServiceController@addslider')?>">
								<i class="fa fa-plus-circle"></i> Add New Slider
							</a>
						</div>
					</div>
				</div>
				    ...
				    <?php $idget = $tt->id; ?>
					 <td>
						<?php if($tt->status==0){ ?>
							  ...
							  <?php } else{ ?>
							  <a class="actionbtn btn-info" href="<?php  echo action('ServiceController@popularslider',[$idget,0])?>">
								<i class="fa fa-star"></i>
							  </a>
						  <?php } ?>
					  </td>
					  <td style="width:200px;">
							<a href="<?php  echo action('ServiceController@editslider',$idget)?>" title="Edit" class="actionbtn btn-info">
								<i class="fa fa-edit"></i>
							</a>
							<a href="<?php echo action('ServiceController@deleteslider',$idget)?>" title="Delete" class="actionbtn btn-danger">
...
$(document).ready(function(){
	...
	function muldelete() {
		...
		$.ajax({
               type:'POST',
               url:'<?php echo Config::get('constants.PROJECT_URL');?>admin/multiSlider',
			...
			alert('Please Select Slider to delete');
		}
