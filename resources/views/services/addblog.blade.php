    ...
    <section class="content">
      <div class="row">
	    <div class="col-md-12" style="margin-bottom: 20px;">
			<a class="btn btn-default" href="<?php echo action([\App\Http\Controllers\ServiceController::class, 'viewblog'])?>" style="font-weight: 600; padding: 8px 16px; border-radius: 8px; border: 1px solid #d0d5dd; background: #fff; color: #344054; text-decoration: none; display: inline-flex; align-items: center; gap: 8px;">
		 ...
		 <div class="box box-primary">
			...
			{{ Form::open(array('action' => [\App\Http\Controllers\ServiceController::class, 'addblog'],'files' => true)) }}
			  {{ csrf_field() }}
              <div class="box-body">
                    <div class="col-md-12 create">
						...
						<div class="col-md-12 text-left" style="padding-right:15px;margin-bottom:20px; display: flex; gap: 12px; align-items: center;">
							...
							<a href="<?php echo action([\App\Http\Controllers\ServiceController::class, 'viewblog'])?>" class="btn btn-default" style="padding: 10px 24px; border-radius: 8px; font-weight: 600; border: 1px solid #d0d5dd; background: #fff; color: #344054; text-decoration: none;">Cancel</a>
						</div>
                    </div>
				</div>
			</form>
