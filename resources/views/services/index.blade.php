...
<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">View All Locations</li>
      </ol>
    </section>
              ...
              <table class="table table-bordered" id="example" border="1">
				...
				<?php
					if(isset($categories)){
						if(!empty($categories)){
							$i=0;
							foreach($categories as $tt){$i++;
				?>
                <tr>
				<td>
							<input type="checkbox" class="form-control checkbox" style="text-align: left;min-height:13px!important;height:3%" name="checkCat" value="<?php echo ucwords($tt->id);?>"/>
						 </td>
                  <td><?php echo $i?></td>
                  <td><?php echo ucwords($tt->name);?></td>
                  <td style="text-align:center;"><?php if($tt->icon!=""){
					  ?>
