...
.status-active { background: #ecfdf3; color: #027a48; border: 1px solid #abefc6; }
.status-inactive { background: #ffefef; color: #b42318; border: 1px solid #fda29b; }
</style>

<div class="content-wrapper">
    <section class="content-header">
      <h1>Multi-Dimensional Strategy</h1>
    </section>
            ...
            <table class="premium-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 100px;">Icon/Image</th>
                        <th>Title</th>
                        <th>Description</th>
                ...
                <tbody>
                    <?php
                        if(isset($allstrategy) && !empty($allstrategy)){
                            $i = 0;
                            foreach($allstrategy as $tt){ 
                                $i++;
                                $idget = $tt->id;
                    ?>
                    <tr>
                        <td><?php echo $i; ?></td>
                        <td>
                            <img src="<?php echo URL::asset('uploads/strategy/'.$tt->image); ?>" class="strategy-img-preview" alt="Icon">
                        </td>
                    ...
                    <?php } } else { ?>
                    <tr>
                        <td colspan="6" style="text-align: center; padding: 48px; color: #98a2b3;">
                            <i class="fa fa-th-large" style="font-size: 32px; margin-bottom: 12px; display: block;"></i>
                            No strategy pillars found.
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
