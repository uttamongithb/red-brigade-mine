    ...
    <section class="content">
        ...
        <div class="form-card">
            <div class="form-header">
                <h5><i class="fa fa-edit" style="color: #E31E24;"></i> Edit Pillar: <?php echo $thisdata->name; ?></h5>
            </div>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="current-preview">
                            <img src="<?php echo URL::asset('uploads/strategy/'.$thisdata->image); ?>" alt="Current Icon">
                        </div>
                        ...
                        <label>Replace Icon/Image (Optional)</label>
