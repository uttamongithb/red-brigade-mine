            ...
            <form action="<?php echo action([\App\Http\Controllers\ServiceController::class, 'addstrategy']); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" name="name" class="form-control-premium" placeholder="e.g. Self-Defense" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="file-upload-wrapper" onclick="document.getElementById('image_upload').click();">
                            ...
                            <div class="file-upload-text">
                                ...
                                <small>Best size: 100x100px (Icon) or 400x500px (Card)</small>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea required name="description" class="form-control-premium" style="height: 120px; resize: none;" placeholder="Explain this strategic approach..."></textarea>
                    </div>

                    <button type="submit" class="btn-submit-premium">
                        <i class="fa fa-check"></i> Save Strategy Pillar
                    </button>
                </div>
            </form>
        </div>
