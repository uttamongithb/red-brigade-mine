...
<div class="rb-topic-page">
    ...
    <section class="rb-topic-hero">
        ...
        <div class="container">
            <span class="rb-kicker">Rehabilitation & Justice</span>
            <h1>Response to Violence</h1>
            <p>Empowering survivors through integrated crisis response, trauma-informed psychological counseling, legal aid, and access to rehabilitation channels.</p>
        </div>
    </section>
