...
.rb-single-blog-page h1, .rb-single-blog-page h2, .rb-single-blog-page h3, .rb-single-blog-page h4 {
...
.rb-post-featured-image {
    ...
    background: #fff; /* in case image is missing */
}
