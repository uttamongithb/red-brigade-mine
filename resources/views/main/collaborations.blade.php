    ...
    <section class="rb-collab-section">
        <div class="container">
            ...
            <div class="rb-collab-grid">
                ...
                <!-- Partner 2 -->
                <div class="rb-collab-card">
                    <div class="rb-collab-logo-box">
                        <img src="<?php echo URL::asset('uploads/img/partners/sri_ram_charitable_trust_logo_1.png'); ?>" alt="Sri Ram Charitable Trust" onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=Sri+Ram+Trust&background=1f2f46&color=fff&size=200&font-size=0.33';">
                    </div>
                ...
                <div class="rb-collab-card">
                    <div class="rb-collab-logo-box">
                        <img src="https://www.rotarypatna.org/images/Roraty_logo.png" alt="Rotary Club Bihar" onerror="this.onerror=null;this.src='https://ui-avatars.com/api/?name=Rotary+Club&background=ff8a00&color=fff&size=200&font-size=0.33';">
                    </div>
                    <h3 style="margin-top: 20px;">Rotary Club Bihar</h3>
