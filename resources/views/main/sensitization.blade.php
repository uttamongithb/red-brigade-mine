...
<div class="rb-topic-page">
    ...
    <section class="rb-topic-hero">
        ...
        <div class="container">
            <span class="rb-kicker">Changing Mindsets</span>
            <h1>Gender Sensitization</h1>
            <p>Dismantling toxic patriarchal structures by engaging young boys, men, and communities through street plays, dialogue, and schools campaigns.</p>
        </div>
    </section>
