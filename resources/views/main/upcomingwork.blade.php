...
<div class="rb-event-page">
    ...
    <section class="rb-event-hero">
        <div class="container">
            <span class="rb-kicker" style="color: #ff8a00;">The Path Ahead</span>
            <h1>Upcoming Work</h1>
            <p>Join our future initiatives and be part of the change. Discover our scheduled workshops and campaigns.</p>
        </div>
    </section>
                ...
                <?php if(!empty($allevent)) { foreach($allevent as $item) { ?>
                    <article class="rb-event-card">
                        ...
                        <div class="rb-event-content">
                            <span class="rb-event-date"><i class="far fa-calendar-alt"></i> <?php echo $item->date; ?></span>
                            ...
                            <a href="{{ $link }}" class="rb-read-more">Join This Event <i class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                <?php }} else { ?>
                    <div style="grid-column: 1/-1; text-align: center; padding: 100px 0;">
                        <i class="fas fa-calendar-plus" style="font-size: 48px; color: #cbd5e1; margin-bottom: 20px;"></i>
                        <h3 style="color: #64748b;">No upcoming work scheduled yet. Stay tuned!</h3>
                    </div>
                <?php } ?>
            </div>
        </div>
    ...
    <section class="rb-event-section" style="padding-top: 0; background: #fff;">
        <div class="container text-center">
            <div style="background: #E31E24; padding: 60px; color: #fff; border: 1px solid #eef2f6;">
                <h2 style="color: #fff; font-size: 36px; margin-bottom: 20px;">Register Your Interest</h2>
                <p style="color: #ffe4e4; font-size: 18px; max-width: 700px; margin: 0 auto 40px;">Want to be notified first when we launch a new workshop in your city? Reach out to us.</p>
                <a href="<?php echo action('MainController@contact'); ?>" class="rb-btn" style="display: inline-block; padding: 14px 40px; background: #fff; color: #E31E24; font-weight: 700; border-radius: 4px; text-decoration: none; text-transform: uppercase; letter-spacing: 1px; transition: 0.3s;" onmouseover="this.style.backgroundColor='#1f2f46'; this.style.color='#fff'" onmouseout="this.style.backgroundColor='#fff'; this.style.color='#E31E24'">Get in Touch</a>
            </div>
        </div>
    </section>
</div>
