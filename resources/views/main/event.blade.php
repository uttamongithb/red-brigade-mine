    ...
    <section class="rb-event-section" style="padding-top: 0; background: #fff;">
        <div class="container text-center">
            <div style="background: #1f2f46; padding: 60px; color: #fff; border: 1px solid #eef2f6;">
                ...
                <a href="<?php echo action('MainController@contact'); ?>" class="rb-btn" style="display: inline-block; padding: 14px 40px; background: #E31E24; color: #fff; font-weight: 700; border-radius: 4px; text-decoration: none; text-transform: uppercase; letter-spacing: 1px; transition: 0.3s;" onmouseover="this.style.backgroundColor='#fff'; this.style.color='#1f2f46'" onmouseout="this.style.backgroundColor='#E31E24'; this.style.color='#fff'">Contact Us Today</a>
            </div>
        </div>
    </section>
</div>
