...
<div class="rb-topic-page">
    ...
    <section class="rb-topic-hero">
        ...
        <div class="container">
            <span class="rb-kicker">Livelihoods & Agency</span>
            <h1>Economic Upliftment</h1>
            <p>Empowering survivors and marginalized women with computer literacy, vocational crafts, and self-help finance to ensure permanent financial autonomy.</p>
        </div>
    </section>
